<template>
  <div class="p0">
    <b-input-group>
      ...
      <b-form-input type="text" v-model="value" debounce="500" v-on:keyup.enter="onSearch"></b-form-input>
    ...
    <b-collapse id="advanced-search" class="">
      <b-tabs content-class="mt-3" fill>
        <b-tab title="Advanced">
          <vue-query-builder v-model="query" :rules="rules" :maxDepth="2">
          </vue-query-builder>
...
import { query_to_rules } from "@/utils/utils";
